...
- **Tap2Crack Backend** - Express + Prisma API (`TAP2CRACK-BACKEND`)
- **Firebase** - Google's mobile development platform (optional)
...
- **Tap2Crack Backend** - Google OAuth and guest sessions via `/api/auth`
